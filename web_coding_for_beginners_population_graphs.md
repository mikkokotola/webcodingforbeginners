...
![Population graph for Nigeria](C:\WORK\random\WorldBank_instructions\pics\samplegraph.png)
...
![World Bank JSON data](C:\WORK\random\WorldBank_instructions\pics\api_finland.png)
...
![Open with code in resource manager](C:\WORK\random\WorldBank_instructions\pics\open_with_vscode.png)

You should see a screen something like this:

![Minimal HTML file in Visual Studio Code](C:\WORK\random\WorldBank_instructions\pics\starthtml.png)
...
![Initial html document](C:\WORK\random\WorldBank_instructions\pics\startview.png)
...
![Titles inserted](C:\WORK\random\WorldBank_instructions\pics\titles.png)
...
![Logging data to console](C:\WORK\random\WorldBank_instructions\pics\console.png)
...
![Array in console](C:\WORK\random\WorldBank_instructions\pics\console_array.png)
...
![Data for Finland in console](C:\WORK\random\WorldBank_instructions\pics\console_countrydata.png)
...
![First population graph, Finland](C:\WORK\random\WorldBank_instructions\pics\first_graph.png)
