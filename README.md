...
- **Create a footer and nice styles for it.** Create a footer for your page and some nice CSS style for it. Look at the instructions and example  [https://www.w3docs.com/learn-html/html-footer-tag.html](https://www.w3docs.com/learn-html/html-footer-tag.html){:target="_blank"}. In the footer, show your own name as the author. Also mention "Based on the Population graphs app (MIT)" and link the license (MIT) to the [full license text](https://github.com/mikkokotola/populationgraphs/blob/master/LICENSE) and mention "Population data: World Bank (CC-BY-4.0)". Mentioning open source license is good practice (read more about licenses in the "Contributing" section below).
